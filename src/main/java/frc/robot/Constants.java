...
public final class Constants{
    ...
    public static final class IntakeConstants{
        ...
        public static final double k_intakeDeployEncoderOffset = .09; 
    ...
    public static final class LauncherConstants{
        ...
        public static double k_launchSpeedRPS = 55; //rotations per second, max ~80, 85 if you strain it. Lowered for festival
