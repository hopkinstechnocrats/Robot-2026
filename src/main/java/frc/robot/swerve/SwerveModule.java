...
public class SwerveModule extends SubsystemBase{
    ...
    SwerveModule(int driveID, int turnID, int absEncoderPort, double absEcoderOffset){
        ...
        table = inst.getTable("Testing Tuning");

        kPInput = new TunableNumber("/Testing Tuning/kPInput", Constants.SwerveConstants.k_driveKP);
        kIInput = new TunableNumber("/Testing Tuning/kIInput", Constants.SwerveConstants.k_driveKI);
        kDInput = new TunableNumber("/Testing Tuning/kDInput", Constants.SwerveConstants.k_driveKD);
